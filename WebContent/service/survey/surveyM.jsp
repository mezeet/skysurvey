		...
		<form action="#">
					...
					<div class="row">
						...
						<div class="small-10 column">
							<div class="row collapse">
								...
								<div class="small-2 columns">
									<input type="text" id="countconf" class="button success"
										value="확인" />
								</div>
							</div>
						</div>
			...
			<div class="row panel view1 hide">
				<div class="small-12 columns">
					...
					<div class="row">
						<div class="small-2 columns">
							<label for="sproblem" class="right"><strong>문제 1</strong><br>
							<small>(30자 이하)</small></label>
						</div>
						<div class="small-10 columns">
					...
					<div class="row">
						...
						<div class="small-10 columns">
							<input type="number" min="2" max="4" id="probcont"
								class="probcontC" />
						</div>
					</div>
			...
			<div class="row panel view2 hide">
				<div class="small-12 columns">
					...
					<div class="row">
						<div class="small-2 columns">
							<label for="sproblem" class="right"><strong>문제 2</strong><br>
							<small>(30자 이하)</small></label>
						</div>
						<div class="small-10 columns">
							<input type="text" id="sproblem" />
			...
			<div class="row panel view3 hide">
				<div class="small-12 columns">
					...
					<div class="row">
						<div class="small-2 columns">
							<label for="sproblem" class="right"><strong>문제 3</strong><br>
							<small>(30자 이하)</small></label>
						</div>
						<div class="small-10 columns">
							<input type="text" id="sproblem" />
...
<script src="${path}/js/jquery-migrate-1.2.1.min.js"
