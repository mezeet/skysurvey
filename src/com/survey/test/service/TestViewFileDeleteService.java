...
import com.survey.test.model.TestListView;
import com.survey.controller.ForwardInfo;
import com.survey.controller.Service;
import com.survey.jdbc.JdbcUtil;

public class TestViewFileDeleteService implements Service {

	@Override
	public ForwardInfo process(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
//		System.out.println("TestListService.process()");
...
//			System.out.println("TestListService.process():startPage-"
//			+startPage+", endPage-"+endPage+", totalPage-"+totalPage);
//			System.out.println
//			("TestListService.process().totalRow:"+totalRow);
			List<Test> list
			= dao.list(con, startRow, endRow, searchKeyArr, searchWord);
			
			TestListView data = new TestListView(
					totalRow, totalPage,
...
//			System.out.println("data.getEndPage():"+data.getEndPage());
		...
		forwardInfo.setForwardStr("/test/list.jsp");
		return forwardInfo;
	}
