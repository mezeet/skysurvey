...
<table border="0">
	<tr>
		<td>회원고유번호</td>
		<td><input type="text" name="txtMemberNum" /></td>
	</tr>
	<tr>
		<td>성명</td>
	...
	<tr>
		<td>집전화</td>
		<td><input type="text" name="txtHomeNum" /></td>
	</tr>
	<tr>
		<td>휴대폰</td>
		<td><input type="text" name="txtMobileNum" /></td>
	</tr>
	<tr>
		<td>집주소</td>
		<td><input type="text" name="txtHomeAddress" /></td>
	</tr>
	<tr>
		<td>등급고유번호</td>
		<td><input type="text" name="txtRatingNum" /></td>
	</tr>
	<tr>
		<td></td>
