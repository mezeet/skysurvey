				...
				<div class="well">
					<form class="form-horizontal" role="form">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="btn-group btn-group-justified">
								  <a type="button" class="btn btn-primary ">투표질문 &nbsp;<i class="fa fa-plus"></i></a>
								  <a type="button" class="btn btn-primary ">답변 &nbsp;<i class="fa fa-plus"></i></a>
								  <a type="button" class="btn btn-primary ">평가 &nbsp;<i class="fa fa-plus"></i></a>
								  <a type="button" class="btn btn-primary ">대결 &nbsp;<i class="fa fa-plus"></i></a>
